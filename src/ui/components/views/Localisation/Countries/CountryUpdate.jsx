...
const CountryUpdate = ({ id, props: { history } }) => {
  ...
  React.useEffect(() => {
    ...
    dispatch(getItem(countryActions, `/${parameters}/${id}`));
  ...
  const onSubmit = (data) => {
    dispatch(updateItem(countryActions, `/${parameters}/${id}`, data));
  };
